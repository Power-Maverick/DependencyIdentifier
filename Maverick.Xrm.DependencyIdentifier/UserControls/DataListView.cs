...
namespace Maverick.Xrm.DependencyIdentifier.UserControls
{
    public partial class DataListView : UserControl
    {
            ...
            switch (DisplayType)
            {
                case Enum.ListViewDisplayType.Entities:
                    ...
                    return new ListViewColumnDefinition[] {
                        new ListViewColumnDefinition("DisplayName", 1, "Display Name") { Width = 200 },
                        new ListViewColumnDefinition( "SchemaName", 0, "Schema Name") { Width = 200 }
                    };
                case Enum.ListViewDisplayType.ComponentTypes:
                    // default the col defs
                    return new ListViewColumnDefinition[] {
        ...
        private ListViewGroup GetListItemGroup(object item, Dictionary<string, PropertyInfo> props = null)
        {
            ...
            var label = bool.Parse(Utility.GetPropertyValue<string>(item, props["IsManaged"]) ?? "false");
            var groupVal = label ? "Managed" : "Unmanaged";
        ...
        private void UpdateSelectedItemsList(ListViewItem listViewItem = null)
        {
            if (listViewItem == null)
            {
                ...
                {
                    case Enum.ListViewDisplayType.Entities:
                        UpdateAllSelectedEntities();
                        break;
                    case Enum.ListViewDisplayType.ComponentTypes:
                        UpdateAllSelectedComponentTypes();
                        break;
                    default:
                        break;
                }
            ...
            else
            {
                ...
                {
                    case Enum.ListViewDisplayType.Entities:
                        UpdateSelectedEntities(listViewItem);
                        break;
                    case Enum.ListViewDisplayType.ComponentTypes:
        ...
        private void UpdateAllSelectedEntities()
        {
        ...
        private void UpdateAllSelectedComponentTypes()
        {
        ...
        private void UpdateSelectedEntities(ListViewItem listItem)
        {
            if (lstSelectedEntitites == null)
            {
                lstSelectedEntitites = new List<EntityMetadata>();
        ...
        {
            UpdateSelectedItemsList(e.Item);
        }
